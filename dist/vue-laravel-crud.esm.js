...
var CrudFilters = __component__$f.exports;
...
var TableRow = __component__$b.exports;
...
var _sfc_render$a = function render() {
  ...
  }, [_vm._v(" Table items: " + _vm._s(_vm.items?.length || 0) + " | itemsList: " + _vm._s(_vm.itemsList?.length || 0) + " | loading: " + _vm._s(_vm.loadingValue) + " | firstLoad: " + _vm._s(_vm.firstLoadValue) + " ")]), _vm.loadingValue || !_vm.firstLoadValue ? _c('div', {
...
var _sfc_render$7 = function render() {
  ...
  return _c('div', {
    ...
    class: _vm.cardClass,
    attrs: {
      "title": _vm.item.title || _vm.item.name || `Item ${_vm.item.id}`,
      "tag": "article",
      "hide-footer": _vm.cardHideFooter
    },
    scopedSlots: _vm._u([{
...
var CrudKanban = __component__$4.exports;
