...
var vuedraggable_umd = createCommonjsModule$1(function (module, exports) {
...
function isSubdomain(subdomain, domain) {
  assert(isString$2(subdomain) && isString$2(domain));
...
// Exports
var followRedirects$1 = wrap$1({ http: http, https: https });
var wrap_1$1 = wrap$1;
followRedirects$1.wrap = wrap_1$1;
  ...
  methods: {
    ...
    removeItem: function (id, index) {
      this.$bvModal.msgBoxConfirm(this.messageRemoveConfirm, {
        ...
        if (value) {
          this.loading = true;
          axios$2.delete(this.apiUrl + "/" + this.modelName + "/" + id).then(response => {
    ...
    async saveItem(event = null) {
      ...
      if (this.item.id) {
        axios$2.put(this.apiUrl + "/" + this.modelName + "/" + this.item.id, this.item).then(response => {
        ...
        if (this.createMultipart) {
          ...
          axios$2.post(this.apiUrl + "/" + this.modelName, formData).then(response => {
            this.loading = false;
          ...
          axios$2.post(this.apiUrl + "/" + this.modelName, this.item).then(response => {
            this.loading = false;
...
const __vue_scope_id__ = "data-v-2d88ff5d";
/* module identifier */
