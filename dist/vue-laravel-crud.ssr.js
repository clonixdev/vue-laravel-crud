...
var InfiniteLoading = /*@__PURE__*/getDefaultExportFromCjs(vueInfiniteLoadingExports);var e=[],t=[];function n(n,r){if(n&&"undefined"!=typeof document){var a,s=!0===r.prepend?"prepend":"append",d=!0===r.singleTag,i="string"==typeof r.container?document.querySelector(r.container):document.getElementsByTagName("head")[0];if(d){var u=e.indexOf(i);-1===u&&(u=e.push(i)-1,t[u]={}),a=t[u]&&t[u][s]?t[u][s]:t[u][s]=c();}else a=c();65279===n.charCodeAt(0)&&(n=n.substring(1)),a.styleSheet?a.styleSheet.cssText+=n:a.appendChild(document.createTextNode(n));}function c(){var e=document.createElement("style");if(e.setAttribute("type","text/css"),r.attributes)for(var t=Object.keys(r.attributes),n=0;n<t.length;n++)e.setAttribute(t[n],r.attributes[t[n]]);var a="prepend"===s?"afterbegin":"beforeend";return i.insertAdjacentElement(a,e),e}}var css = "tr td[data-v-99889a03]:last-child,\ntr td[data-v-99889a03]:first-child {\n  width: 1%;\n  white-space: nowrap; }\n\n.crud-pagination[data-v-99889a03] {\n  display: flex;\n  justify-content: center; }\n\n.crud-header[data-v-99889a03] {\n  display: flex;\n  justify-content: space-between;\n  max-height: 3rem; }\n  .crud-header[data-v-99889a03] .crud-title[data-v-99889a03] {\n    margin: 0; }\n  .crud-header[data-v-99889a03] .crud-search[data-v-99889a03] {\n    max-width: 15rem; }\n    .crud-header[data-v-99889a03] .crud-search[data-v-99889a03] .btn[data-v-99889a03] {\n      border-top-left-radius: 0;\n      border-bottom-left-radius: 0;\n      border-top-right-radius: 0.375rem;\n      border-bottom-right-radius: 0.375rem; }\n      .crud-header[data-v-99889a03] .crud-search[data-v-99889a03] .btn[data-v-99889a03].open[data-v-99889a03] {\n        border-top-right-radius: 0;\n        border-bottom-right-radius: 0; }\n  .crud-header[data-v-99889a03] .table-options[data-v-99889a03] {\n    margin-bottom: 1rem;\n    display: flex;\n    align-items: center;\n    justify-content: flex-end; }\n\n.custom-control[data-v-99889a03] {\n  position: relative;\n  top: -15px; }\n\n@media (min-width: 992px) {\n  .table[data-v-99889a03] {\n    table-layout: auto; }\n    .table[data-v-99889a03] tbody[data-v-99889a03] td[data-v-99889a03] {\n      overflow: scroll;\n      -ms-overflow-style: none;\n      /* IE and Edge */\n      scrollbar-width: none;\n      /* Firefox */ }\n    .table[data-v-99889a03] tbody[data-v-99889a03] td[data-v-99889a03]::-webkit-scrollbar {\n      display: none; } }\n";
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              console.debug("save item 1", _this16.item);
              jsondata = _this16.item.$toJson();
              console.debug("save item 2", _this16.item, jsondata);
              create = false;
              if (!_this16.item.id) {
                _context4.next = 12;
                break;
              ...
              _context4.next = 8;
              return _this16.model.api().put('/' + _this16.item.id, jsondata);
            case 8:
            ...
            case 12:
              _context4.next = 14;
              return _this16.model.api().post('', jsondata);
            case 14:
              result = _context4.sent;
              create = true;
            case 16:
              ...
              _this16.toastError(result.response.data.error);
            ...
            case 21:
              ...
              if (_this16.hideModalAfterSave || create && _this16.hideModalAfterCreate || !create && _this16.hideModalAfterUpdate) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              itemSave = JSON.parse(JSON.stringify(_this17.item));
              if (_this17.item.id || _this17.item.index) {
                if (_this17.item.id) {
                  ...
                  itemIndex = _this17.items.findIndex(function (item) {
                    return item.index == _this17.item.index;
                  });
                }
                _this17.items[itemIndex] = itemSave;
                if (_this17.hideModalAfterSave || _this17.hideModalAfterUpdate) {
                  _this17.$bvModal.hide("modal-form-item-" + _this17.modelName);
                }
              } else {
                itemSave.index = _this17.items.length + 1;
                _this17.items.push(itemSave);
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              ...
              validation_error_message = _this18.messageDefaultValidationError;
              if (validation_result) {
                _context6.next = 8;
                break;
              }
              _this18.toastError(validation_error_message);
            ...
            case 11:
              if (!_this18.useVuexORM) {
                _context6.next = 13;
                break;
              }
              return _context6.abrupt("return", _this18.saveItemVuex(event));
            case 13:
              if (_this18.ajax) {
                _context6.next = 15;
                break;
              }
              return _context6.abrupt("return", _this18.saveItemLocal(event));
            case 15:
              if (_this18.item.id) {
                axios.put(_this18.apiUrl + "/" + _this18.modelName + "/" + _this18.item.id, _this18.item).then(function (response) {
                  ...
                  var itemIndex = _this18.items.findIndex(function (item) {
                    return item.id == _this18.item.id;
                  });
                  _this18.items[itemIndex] = itemSv;
                  _this18.item = itemSv;
                  _this18.loading = false;
                  if (_this18.refreshAfterSave) _this18.refresh();
                  _this18.toastSuccess("Elemento Modificado");
                  _this18.$emit("itemSaved", {
                    item: _this18.item
                  });
                  _this18.$emit("itemUpdated", {
                    item: _this18.item
                  });
                }).catch(function (error) {
                ...
                if (_this18.createMultipart) {
                  formData = new FormData();
                  Object.keys(_this18.item).forEach(function (key) {
                    if (_this18.item[key][0] && _this18.item[key][0].name) {
                      var files = _this18.item[key];
                      for (var x = 0; x < files.length; x++) {
                        formData.append(key + "[]", _this18.item[key][x], _this18.item[key][x].name);
                      }
                    } else formData.append(key, _this18.item[key]);
                  });
                  axios.post(_this18.apiUrl + "/" + _this18.modelName, formData).then(function (response) {
                    _this18.loading = false;
                    ...
                    if (response.data.success) {
                      if (response.data.message) {
                        _this18.toastSuccess(response.data.message);
                      }
                      return;
                    }
                    var itemSv = response.data;
                    _this18.items.push(itemSv);
                    _this18.item = itemSv;
                    if (_this18.refreshAfterSave) _this18.refresh();
                    _this18.toastSuccess("Elemento Creado");
                    _this18.$emit("itemSaved", {
                      item: _this18.item
                    });
                    _this18.$emit("itemCreated", {
                      item: _this18.item
                    });
                  }).catch(function (error) {
                    _this18.toastError(error);
                  ...
                  axios.post(_this18.apiUrl + "/" + _this18.modelName, _this18.item).then(function (response) {
                    _this18.loading = false;
                    if (_this18.hideModalAfterSave || _this18.hideModalAfterUpdate) {
                      _this18.$bvModal.hide("modal-form-item-" + _this18.modelName);
                    }
...
var __component__ = /*#__PURE__*/normalizeComponent(_sfc_main, _sfc_render, _sfc_staticRenderFns, false, null, "99889a03", null, null);
