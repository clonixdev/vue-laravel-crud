...
var PluginManager = {
  mount: function mount(plugin) {
    ...
    for (var option in defaults$6) {
      if (defaults$6.hasOwnProperty(option) && !(option in plugin)) {
        plugin[option] = defaults$6[option];
      }
    }
...
Sortable.mount(Remove, Revert);var sortable_esm=/*#__PURE__*/Object.freeze({__proto__:null,'default':Sortable,MultiDrag:MultiDragPlugin,Sortable:Sortable,Swap:SwapPlugin});var require$$0 = /*@__PURE__*/getAugmentedNamespace(sortable_esm);(function (module, exports) {
	...
	})((typeof self !== 'undefined' ? self : commonjsGlobal$1), function(__WEBPACK_EXTERNAL_MODULE_a352__) {
...
var draggable = /*@__PURE__*/getDefaultExportFromCjs(vuedraggable_umdExports);var global$1 = (typeof global !== "undefined" ? global :
  typeof self !== "undefined" ? self :
  typeof window !== "undefined" ? window : {});function bind$3(fn, thisArg) {
 ...
 */
const isStream$1 = (val) => isObject$2(val) && isFunction$2(val.pipe);
...
const hasOwnProperty$k = (({hasOwnProperty}) => (obj, prop) => hasOwnProperty.call(obj, prop))(Object.prototype);
...
var utils$9 = {
  ...
  matchAll,
  isHTMLForm,
  hasOwnProperty: hasOwnProperty$k,
  hasOwnProp: hasOwnProperty$k, // an alias to avoid ESLint no-prototype-builtins detection
  reduceDescriptors,
  freezeMethods,
  toObjectSet,
  toCamelCase,
...
AxiosError.from = (error, code, config, request, response, customProps) => {
  ...
  utils$9.toFlatObject(error, axiosError, function filter(obj) {
...
const predicates = utils$9.toFlatObject(utils$9, {}, null, function filter(prop) {
...
function toFormData(obj, formData, options) {
  ...
  function convertValue(value) {
    ...
    if (utils$9.isDate(value)) {
      return value.toISOString();
    }

    if (!useBlob && utils$9.isBlob(value)) {
      throw new AxiosError('Blob is not supported. Use a Buffer instead.');
    }

    if (utils$9.isArrayBuffer(value) || utils$9.isTypedArray(value)) {
  ...
  function defaultVisitor(value, key, path) {
    ...
    if (value && !path && typeof value === 'object') {
      if (utils$9.endsWith(key, '{}')) {
        ...
        (utils$9.isArray(value) && isFlatArray(value)) ||
        ((utils$9.isFileList(value) || utils$9.endsWith(key, '[]')) && (arr = utils$9.toArray(value))
        )) {
        // eslint-disable-next-line no-param-reassign
  ...
  function build(value, path) {
    if (utils$9.isUndefined(value)) return;
    ...
    utils$9.forEach(value, function each(el, key) {
      const result = !(utils$9.isUndefined(el) || el === null) && visitor.call(
        formData, el, utils$9.isString(key) ? key.trim() : key, path, exposedHelpers
      );
...
function buildURL$2(url, params, options) {
  ...
  if (serializeFn) {
    ...
    serializedParams = utils$9.isURLSearchParams(params) ?
      params.toString() :
...
};var URLSearchParams$1 = typeof URLSearchParams !== 'undefined' ? URLSearchParams : AxiosURLSearchParams;var FormData$1 = typeof FormData !== 'undefined' ? FormData : null;var Blob$1 = typeof Blob !== 'undefined' ? Blob : null;/**
...
var platform$1 = {
  ...
  return toFormData(data, new platform$1.classes.URLSearchParams(), Object.assign({
    visitor: function(value, key, path, helpers) {
      if (platform$1.isNode && utils$9.isBuffer(value)) {
...
function formDataToJSON(formData) {
  ...
  if (utils$9.isFormData(formData) && utils$9.isFunction(formData.entries)) {
    ...
    utils$9.forEachEntry(formData, (name, value) => {
...
const defaults$5 = {
  ...
  transformRequest: [function transformRequest(data, headers) {
    ...
    const isFormData = utils$9.isFormData(data);
    ...
    if (isObjectPayload) {
      ...
      if ((isFileList = utils$9.isFileList(data)) || contentType.indexOf('multipart/form-data') > -1) {
  ...
  transformResponse: [function transformResponse(data) {
    const transitional = this.transitional || defaults$5.transitional;
...
utils$9.forEach(['post', 'put', 'patch'], function forEachMethodWithData(method) {
  defaults$5.headers[method] = utils$9.merge(DEFAULT_CONTENT_TYPE$1);
...
function normalizeValue(value) {
  ...
  return utils$9.isArray(value) ? value.map(normalizeValue) : String(value);
}
...
function matchHeaderValue(context, value, header, filter, isHeaderNameFilter) {
  ...
  if (!utils$9.isString(value)) return;

  if (utils$9.isString(filter)) {
    return value.indexOf(filter) !== -1;
  }

  if (utils$9.isRegExp(filter)) {
...
class AxiosHeaders {
  ...
  set(header, valueOrRewrite, rewrite) {
    ...
    function setHeader(_value, _header, _rewrite) {
      ...
      const key = utils$9.findKey(self, lHeader);
    ...
    const setHeaders = (headers, _rewrite) =>
      utils$9.forEach(headers, (_value, _header) => setHeader(_value, _header, _rewrite));

    if (utils$9.isPlainObject(header) || header instanceof this.constructor) {
      setHeaders(header, valueOrRewrite);
    } else if(utils$9.isString(header) && (header = header.trim()) && !isValidHeaderName(header)) {
  ...
  get(header, parser) {
    ...
    if (header) {
      ...
      if (key) {
        ...
        if (utils$9.isFunction(parser)) {
          return parser.call(this, value, key);
        }

        if (utils$9.isRegExp(parser)) {
  ...
  delete(header, matcher) {
    ...
    function deleteHeader(_header) {
      ...
      if (_header) {
        const key = utils$9.findKey(self, _header);
  ...
  normalize(format) {
    ...
    utils$9.forEach(this, (value, header) => {
  ...
  toJSON(asStrings) {
    ...
    utils$9.forEach(this, (value, header) => {
      value != null && value !== false && (obj[header] = asStrings && utils$9.isArray(value) ? value.join(', ') : value);
    });
...
utils$9.freezeMethods(AxiosHeaders.prototype);
...
var xhrAdapter = isXHRAdapterSupported && function (config) {
  return new Promise(function dispatchXhrRequest(resolve, reject) {
    ...
    if (utils$9.isFormData(requestData) && (platform$1.isStandardBrowserEnv || platform$1.isStandardBrowserWebWorkerEnv)) {
...
utils$9.forEach(knownAdapters, (fn, value) => {
  if(fn) {
    try {
...
var adapters = {
  getAdapter: (adapters) => {
    adapters = utils$9.isArray(adapters) ? adapters : [adapters];
    ...
    for (let i = 0; i < length; i++) {
      ...
      if((adapter = utils$9.isString(nameOrAdapter) ? knownAdapters[nameOrAdapter.toLowerCase()] : nameOrAdapter)) {
        break;
      }
    }
    ...
    if (!adapter) {
      ...
      throw new Error(
        utils$9.hasOwnProp(knownAdapters, nameOrAdapter) ?
          `Adapter '${nameOrAdapter}' is not available in the build` :
          `Unknown adapter '${nameOrAdapter}'`
      );
    }

    if (!utils$9.isFunction(adapter)) {
...
function mergeConfig$3(config1, config2) {
  ...
  utils$9.forEach(Object.keys(config1).concat(Object.keys(config2)), function computeConfigValue(prop) {
    const merge = mergeMap[prop] || mergeDeepProperties;
    const configValue = merge(config1[prop], config2[prop], prop);
    (utils$9.isUndefined(configValue) && merge !== mergeDirectKeys) || (config[prop] = configValue);
  });

  return config;
}const VERSION = "1.3.5";const validators$1 = {};
...
class Axios$2 {
  ...
  request(configOrUrl, config) {
    ...
    // Flatten headers
    contextHeaders = headers && utils$9.merge(
      headers.common,
      headers[config.method]
    );

    contextHeaders && utils$9.forEach(
    ...
    if (!synchronousRequestInterceptors) {
      const chain = [dispatchRequest$2.bind(this), undefined];
...
function createInstance$1(defaultConfig) {
  ...
  utils$9.extend(instance, Axios$2.prototype, context, {allOwnKeys: true});
...
const axios$4 = createInstance$1(defaults$5);
...
// Expose isAxiosError
axios$4.isAxiosError = isAxiosError;
...
axios$4.formToJSON = thing => formDataToJSON(utils$9.isHTMLForm(thing) ? new FormData(thing) : thing);

axios$4.HttpStatusCode = HttpStatusCode;

axios$4.default = axios$4;function commonjsRequire(path) {
...
var moment = momentExports;var axiosExports$1 = {};
var axios$3 = {
...
var InterceptorManager_1 = InterceptorManager$1;var utils$5 = utils$8;
...
function getDefaultAdapter() {
  ...
  if (typeof browser$1 !== 'undefined' && Object.prototype.toString.call(browser$1) === '[object process]') {
...
module.exports = defaults$3;var defaults$4=/*#__PURE__*/Object.freeze({__proto__:null});var require$$4 = /*@__PURE__*/getAugmentedNamespace(defaults$4);/**
 * Determines whether the specified URL is absolute
 *
 * @param {string} url The URL to test
 * @returns {boolean} True if the specified URL is absolute, otherwise false
...
var mergeConfig$2 = function mergeConfig(config1, config2) {
  ...
  utils$2.forEach(['url', 'method', 'params', 'data'], function valueFromConfig2(prop) {
    if (typeof config2[prop] !== 'undefined') {
      config[prop] = config2[prop];
    }
  });

  utils$2.forEach(['headers', 'auth', 'proxy'], function mergeDeepProperties(prop) {
...
var Axios_1 = Axios$1;var Cancel_1;
...
axiosExports.default = axios$1;(function (module) {
	module.exports = axiosExports;
} (axios$3));

var axios = /*@__PURE__*/getDefaultExportFromCjs(axiosExports$1);function _classCallCheck(instance, Constructor) {
...
var autobind = function autobind(instance) {
  for (var obj = instance; obj; obj = Object.getPrototypeOf(obj)) {
    ...
    var names = Object.getOwnPropertyNames(obj); // Bind each function to the instance.

    for (var i = 0; i < names.length; i++) {
      var name = names[i]; // No need to bind getters, as attempting to access them would also
...
function () {
  ...
  _createClass(Response, [{
    ...
    value: function getData() {
      return get_1(this.response, 'data', null);
    }
  }, {
    key: "getStatus",
    value: function getStatus() {
      return get_1(this.response, 'status');
    }
  }, {
    key: "getHeaders",
    value: function getHeaders() {
      return get_1(this.response, 'headers', {});
    }
  }, {
...
function () {
  ...
  _createClass(Request, [{
    key: "createResponse",
    value: function createResponse(axiosResponse) {
    ...
    key: "createError",
    value: function createError(axiosError) {
    ...
    value: function send() {
      ...
      return axios.request(this.config).then(this.createResponse)["catch"](function (error) {
        throw _this.createError(error);
      });
    }
  }]);
...
var defaults = _baseRest(function(object, sources) {
  ...
  while (++index < length) {
    ...
    while (++propsIndex < propsLength) {
      ...
      if (value === undefined ||
          (eq_1(value, objectProto$c[key]) && !hasOwnProperty$a.call(object, key))) {
...
var REQUEST_CONTINUE = 0;
var REQUEST_REDUNDANT = 1;
var REQUEST_SKIP = 2;
/**
...
function () {
  function Base(options) {
    ...
    autobind(this); // Define an automatic unique ID. This is primarily to distinguish
    ...
    Vue__default["default"].set(this, '_listeners', {}); // Event listeners

    Vue__default["default"].set(this, '_options', {}); // Internal option store
  ...
  _createClass(Base, [{
    ...
    key: "toString",
    value: function toString() {
      return "<".concat(this.$class, " #").concat(this._uid, ">");
    }
    /**
    ...
    value: function emit(event) {
      ...
      var listeners = get_1(this._listeners, event);
      ...
      context = defaults_1({}, context, this.getDefaultEventContext()); // Run through each listener. If any of them return false, stop the
    ...
    value: function on(event, listener) {
      ...
      var events = map_1(split_1(event, ','), trim_1);
    ...
    value: function getOption(path) {
      ...
      return get_1(this._options, path, fallback);
    }
    /**
    ...
    value: function setOption(path, value) {
      set_1(this._options, path, value);
    }
    /**
    ...
    value: function setOptions() {
      ...
      Vue__default["default"].set(this, '_options', defaultsDeep_1.apply(void 0, [{}].concat(options, [// Given options
    ...
    value: function getOptions() {
      return defaultTo_1(this._options, {});
    }
    /**
    ...
    value: function getDefaultRouteResolver() {
      ...
      return function (route) {
        ...
        var replacements = _this2.getRouteReplacements(route, parameters); // Replace all route parameters with their replacement values.


        return reduce_1(replacements, function (result, value, parameter) {
          return replace_1(result, parameter, value);
        }, route);
      };
    }
    /**
    ...
    value: function getValidationErrorStatus() {
      return defaultTo_1(this.getOption('validationErrorStatus'), 422);
    }
    /**
    ...
    value: function getRoute(key, fallback) {
      var route = get_1(this.routes(), key, get_1(this.routes(), fallback));
    ...
    value: function createRequestError(error, response) {
    ...
    value: function createResponseError(error, response) {
    ...
    value: function createValidationError(errors, message) {
    ...
    value: function request(config, onRequest, onSuccess, onFailure) {
      ...
      return new Promise(function (resolve, reject) {
        return onRequest().then(function (status) {
          switch (status) {
            ...
            case REQUEST_REDUNDANT:
              // Skip, but consider it a success.
              onSuccess(null);
              resolve(null);
              return;
          ...
          return _this3.createRequest(config).send().then(function (response) {
            onSuccess(response);
            resolve(response);
    ...
    value: function fetch() {
      ...
      var config = function config() {
        return {
          url: defaultTo_1(options.url, _this4.getFetchURL()),
          method: defaultTo_1(options.method, _this4.getFetchMethod()),
          params: defaults_1(options.params, _this4.getFetchQuery()),
          headers: defaults_1(options.headers, _this4.getFetchHeaders())
        };
      };
    ...
    value: function save() {
      ...
      var config = function config() {
        return {
          url: defaultTo_1(options.url, _this5.getSaveURL()),
          method: defaultTo_1(options.method, _this5.getSaveMethod()),
          data: defaultTo_1(options.data, _this5.getSaveData()),
          params: defaults_1(options.params, _this5.getSaveQuery()),
          headers: defaults_1(options.headers, _this5.getSaveHeaders())
        };
      };
    ...
    value: function upload() {
      ...
      var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var data = defaultTo_1(options.data, this.getSaveData());

      var config = function config() {
        return assign_1(options, {
          data: _this6.convertObjectToFormData(data)
        });
      };
    ...
    value: function _delete() {
      ...
      var config = function config() {
        return {
          url: defaultTo_1(options.url, _this7.getDeleteURL()),
          method: defaultTo_1(options.method, _this7.getDeleteMethod()),
          data: defaultTo_1(options.data, _this7.getDeleteBody()),
          params: defaults_1(options.params, _this7.getDeleteQuery()),
          headers: defaults_1(options.headers, _this7.getDeleteHeaders())
        };
      };
...
function toSafeInteger(value) {
  return value
    ? _baseClamp(toInteger_1(value), -MAX_SAFE_INTEGER$2, MAX_SAFE_INTEGER$2)
    : (value === 0 ? value : 0);
}
...
function () {
  function ProxyResponse(status) {
    ...
    this.data = defaultTo_1(data, {});
    this.headers = defaultTo_1(headers, {});
    this.status = toSafeInteger_1(status);
  }
...
function (_Base) {
  ...
  function Collection() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Collection).call(this, options));
    Vue__default["default"].set(_assertThisInitialized(_this), 'models', []); // Model store.

    Vue__default["default"].set(_assertThisInitialized(_this), '_attributes', {}); // Property store.

    Vue__default["default"].set(_assertThisInitialized(_this), '_registry', {}); // Model registry.

    Vue__default["default"].set(_assertThisInitialized(_this), '_page', NO_PAGE);

    _this.clearState(); // Set all given attributes.


    _this.set(defaultsDeep_1({}, attributes, _this.defaults())); // Add all given models (if any) to this collection. We explicitly ask
    // for the values here as it's common for some sources to be objects.


    if (models) {
      _this.add(values_1(models));
    }
  ...
  _createClass(Collection, [{
    ...
    value: function get(attribute, fallback) {
      return get_1(this._attributes, attribute, fallback);
    }
    /**
    ...
    value: function set(attribute, value) {
      ...
      if (isPlainObject_1(attribute)) {
        each(attribute, function (value, key) {
      ...
      Vue__default["default"].set(this._attributes, attribute, value);
    }
    /**
     * @return {Object}
     */
    ...
    key: "getDefaultOptions",
    value: function getDefaultOptions() {
      return merge_1(_get(_getPrototypeOf(Collection.prototype), "getDefaultOptions", this).call(this), {
    ...
    key: "getRouteParameters",
    value: function getRouteParameters() {
      return merge_1({}, _get(_getPrototypeOf(Collection.prototype), "getRouteParameters", this).call(this), this._attributes, {
        page: this._page
      });
    }
    /**
    ...
    value: function clearErrors() {
      each(this.models, method_1('clearErrors'));
    }
    /**
    ...
    value: function clearState() {
      Vue__default["default"].set(this, 'loading', false);
      Vue__default["default"].set(this, 'saving', false);
      Vue__default["default"].set(this, 'deleting', false);
      Vue__default["default"].set(this, 'fatal', false);
    }
    /**
    ...
    value: function clearModels() {
      ...
      var models = this.models; // Clear the model store, but keep a reference.

      Vue__default["default"].set(this, 'models', []); // Notify each model that it has been removed from this collection.
    ...
    key: "sync",
    value: function sync() {
      each(this.models, method_1('sync'));
    }
    /**
    ...
    value: function reset() {
      for (var _len = arguments.length, attribute = new Array(_len), _key = 0; _key < _len; _key++) {
        attribute[_key] = arguments[_key];
      }

      each(this.models, method_1.apply(void 0, ['reset'].concat(attribute)));
    }
    /**
    ...
    value: function validate() {
      var validations = this.models.map(function (model) {
        return model.validate();
      });
      return Promise.all(validations).then(function (errors) {
        return every_1(errors, isEmpty_1) ? [] : errors;
      });
    }
    /**
    ...
    value: function removeModelFromRegistry(model) {
      unset_1(this._registry, model._uid);
    }
    /**
    ...
    value: function hasModelInRegistry(model) {
      return has_1(this._registry, model._uid);
    }
    /**
    ...
    value: function addModelToRegistry(model) {
      set_1(this._registry, model._uid, 1);
    }
    /**
    ...
    value: function add() {
      ...
      this.onAdd(model); // We're assuming that the collection is not loading once a model is added.
    ...
    value: function _removeModelAtIndex(index) {
      ...
      var model = get_1(this.models, index);

      Vue__default["default"]["delete"](this.models, index);
      this.onRemove(model);
      return model;
    }
    /**
    ...
    value: function remove(model) {
      ...
      if (isFunction_1(model) || isPlainObject_1(model)) {
        return this.remove(filter_1(this.models, model));
      ...
      if (isArray_1(model)) {
        return filter_1(map_1(model, this.remove));
    ...
    value: function isModel(candidate) {
      return isObject_1(candidate) && has_1(candidate, '_attributes') && has_1(candidate, '_uid');
    }
    /**
    ...
    value: function indexOf(model) {
      var filter = model; // Getting the index of a model instance can be optimised.
      ...
      if (this.isModel(filter)) {
        ...
        if (!has_1(this._registry, model._uid)) {
          return -1;
      ...
      return findIndex_1(this.models, filter);
    }
    /**
    ...
    value: function find(where) {
      return find_1(this.models, where);
    }
    /**
    ...
    value: function filter(predicate) {
      ...
      result.models = filter_1(result.models, predicate);
      return result;
    }
    /**
    ...
    value: function where(predicate) {
      return filter_1(this.models, predicate);
    }
    /**
    ...
    value: function map(callback) {
      return map_1(this.models, callback);
    }
    /**
    ...
    key: "reduce",
    value: function reduce(iteratee, initial) {
      // Use the first model as the initial value if an initial was not given.
      if (arguments.length === 1) {
        initial = this.first();
      }

      return reduce_1(this.models, iteratee, initial);
    }
    /**
    ...
    value: function sum(iteratee) {
      return sumBy_1(this.models, iteratee);
    }
    /**
    ...
    value: function count(iteratee) {
      return countBy_1(this.models, iteratee);
    }
    /**
    ...
    value: function sort(comparator) {
      Vue__default["default"].set(this, 'models', sortBy_1(this.models, comparator));
    }
    /**
    ...
    key: "replace",
    value: function replace(models) {
      this.clearModels();
      this.add(values_1(models));
    }
    /**
    ...
    key: "getPaginationQuery",
    value: function getPaginationQuery() {
      return {
        page: this._page
      };
    }
    ...
    value: function getFetchQuery() {
      ...
      return _get(_getPrototypeOf(Collection.prototype), "getFetchQuery", this).call(this);
    }
    /**
    ...
    value: function getModelsFromResponse(response) {
      var models = response.getData(); // An empty, non-array response indicates that we didn't intend to send
      // any models in the response. This means that the current models are
      // already up to date, as no changes are necessary.

      if (isNil_1(models) || models === '') {
        return null;
      ...
      if (this.isPaginated()) {
        return get_1(models, 'data', models);
      }
    ...
    value: function onSaveSuccess(response) {
      ...
      var saved = this.getModelsFromResponse(response); // All the models that are currently being saved.

      var saving = this.getSavingModels(); // Empty response is similar to an empty response returned when saving
      // a model: assume that the attributes are the saved state, so sync.

      if (isNil_1(saved)) {
        each(saving, method_1('sync'));
      } else {
        ...
        each(saved, function (data, index) {
    ...
    value: function getSavingModels() {
      return filter_1(this.models, 'saving');
    }
    /**
    ...
    value: function getDeletingModels() {
      return filter_1(this.models, 'deleting');
    }
    /**
    ...
    value: function applyValidationErrorArray(errors) {
      var models = this.getSavingModels(); // To allow matching errors with models, it's a strict requirement and
      ...
      each(models, function (model, index) {
        model.setErrors(errors[index]);
        Vue__default["default"].set(model, 'saving', false);
        Vue__default["default"].set(model, 'fatal', false);
      });
    }
    /**
    ...
    value: function applyValidationErrorObject(errors) {
      var lookup = keyBy_1(this.models, function (model) {
        return model.identifier();
      });

      each(errors, function (errors, identifier) {
        var model = get_1(lookup, identifier);
    ...
    value: function setErrors(errors) {
      ...
      if (isArray_1(errors)) {
        this.applyValidationErrorArray(errors); // Support an object of errors keyed by model identifiers.
      } else if (isPlainObject_1(errors)) {
    ...
    value: function getErrors() {
      return map_1(this.models, 'errors');
    }
    /**
    ...
    value: function onSaveValidationFailure(error) {
      ...
      if (!isPlainObject_1(errors) && !isArray_1(errors)) {
    ...
    value: function onFatalSaveFailure(error, response) {
      each(this.getSavingModels(), function (model) {
        model.onFatalSaveFailure(error, response);
      });

      Vue__default["default"].set(this, 'fatal', true);
      Vue__default["default"].set(this, 'saving', false);
    }
    /**
    ...
    value: function onSaveFailure(error) {
      if (this.isBackendValidationError(error)) {
        this.onSaveValidationFailure(error); // Not a validation error, so something else went wrong.
      } else {
    ...
    value: function getSaveData() {
      return map_1(this.getSavingModels(), method_1('getSaveData'));
    }
    /**
    ...
    value: function page(_page) {
      ...
      if (isNil_1(_page)) {
        Vue__default["default"].set(this, '_page', NO_PAGE); // Page was provided, so we should either set the page or disable
        // pagination entirely if the page is `false`.
      } else {
        Vue__default["default"].set(this, '_page', max_1([1, toSafeInteger_1(_page)]));
      }
    ...
    value: function applyPagination(models) {
      ...
      if (isEmpty_1(models)) {
        Vue__default["default"].set(this, '_page', LAST_PAGE); // Otherwise, there were at least one model, and we can safely
        // assume that we want to increment the page number.
      } else {
        Vue__default["default"].set(this, '_page', this._page + 1);
        this.add(models);
      }
    }
    /**
    ...
    value: function onFetchSuccess(response) {
      var models = this.getModelsFromResponse(response); // There is no sensible alternative to an array here, so anyting else
      // is considered an exception that indicates an unexpected state.
      ...
      if (this.isPaginated()) {
        this.applyPagination(models); // Replace all current models with the fetched ones.
      } else {
        this.replace(models);
      }
    ...
    value: function onFetch() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        if (_this4.isPaginated() && _this4.isLastPage()) {
        ...
        Vue__default["default"].set(_this4, 'loading', true);
    ...
    value: function onDeleteSuccess(response) {
      ...
      each(this.getDeletingModels(), function (model) {
    ...
    value: function onSave() {
      ...
      var valid = true;
      var tasks = this.models.map(function (model) {
        return model.onSave()["catch"](function (error) {
      ...
      return Promise.all(tasks).then(function () {
        if (!valid) {
          throw new ValidationError(_this5.getErrors());
        }

        Vue__default["default"].set(_this5, 'saving', true);
    ...
    value: function getIdentifiers(models) {
      return map_1(models, method_1('identifier'));
    }
    /**
     * @inheritDoc
     */
    ...
    value: function getDeleteQuery() {
      ...
      return _defineProperty({}, identifier, join_1(identifiers, ','));
    }
    /**
    ...
    value: function onDelete() {
      ...
      return Promise.all(this.models.map(function (m) {
        ...
        if (isEmpty_1(_this6.getDeletingModels())) {
          return Base.REQUEST_REDUNDANT;
        }

        Vue__default["default"].set(_this6, 'deleting', true);
        return Base.REQUEST_CONTINUE;
      });
    }
    /**
...
cloneableTags[regexpTag$4] = cloneableTags[setTag$7] =
...
function getFuncName(func) {
  var result = (func.name + ''),
      ...
      length = hasOwnProperty$i.call(_realNames, result) ? array.length : 0;
...
function lodash(value) {
  if (isObjectLike_1(value) && !isArray_1(value) && !(value instanceof _LazyWrapper)) {
    ...
    if (hasOwnProperty$j.call(value, '__wrapped__')) {
...
var RESERVED = invert_1(['_attributes', '_collections', '_errors', '_listeners', '_reference', '_registry', '_uid', 'attributes', 'collections', 'deleting', 'errors', 'fatal', 'loading', 'memoized', 'models', 'saving']);
/**
...
var copyFrom = function copyFrom(source, target, keys) {
  if (keys) {
    source = pick_1(source, keys);
  }

  each(source, function (value, key) {
    if (isArray_1(value)) {
      Vue__default["default"].set(target, key, []);
      copyFrom(value, target[key]);
    } else if (isPlainObject_1(value)) {
      Vue__default["default"].set(target, key, {});
      copyFrom(value, target[key]);
    } else if (isObject_1(value) && isFunction_1(value.clone)) {
      Vue__default["default"].set(target, key, value.clone());
    } else {
      Vue__default["default"].set(target, key, cloneDeep_1(value));
    }
  });
};
/**
...
function (_Base) {
  ...
  _createClass(Model, [{
    ...
    key: "collections",
    get: function get() {
      return values_1(this._collections);
    }
    /**
  ...
  function Model() {
    ...
    Vue__default["default"].set(_assertThisInitialized(_this), '_collections', {}); // Collections that contain this model.

    Vue__default["default"].set(_assertThisInitialized(_this), '_reference', {}); // Saved attribute state.

    Vue__default["default"].set(_assertThisInitialized(_this), '_attributes', {}); // Active attribute state.

    Vue__default["default"].set(_assertThisInitialized(_this), '_mutations', {}); // Mutator cache.

    Vue__default["default"].set(_assertThisInitialized(_this), '_errors', {}); // Validation errors.

    _this.clearState(); // Cache certain methods that don't need to be evaluated more than once.


    _this.memoize(); // Cache mutator pipelines so that they can run as a single function.


    _this.compileMutators(); // Assign all given model data to the model's attributes and reference.


    _this.assign(attributes); // Register the given collection (if any) to the model. This is so that
  ...
  _createClass(Model, [{
    ...
    value: function clone() {
      var attributes = {};
      var reference = {}; // Clone all attributes and their descriptors.

      copyFrom(this._attributes, attributes);
      copyFrom(this._reference, reference); // Create a copy.

      var clone = new this.constructor(); // Make sure that the clone belongs to the same collections.

      clone.registerCollection(this.collections); // Make sure that the clone has the same existing options.

      clone.setOptions(this.getOptions());
      Vue__default["default"].set(clone, '_reference', reference);
      Vue__default["default"].set(clone, '_attributes', attributes);
      return clone;
    }
    /**
    ...
    value: function memoize() {
      ...
      'routes'];
      each(memoized, function (name) {
        return _this2[name] = once_1(_this2[name]);
      });
    }
    /**
    ...
    key: "getDefaultOptions",
    value: function getDefaultOptions() {
      return merge_1({}, _get(_getPrototypeOf(Model.prototype), "getDefaultOptions", this).call(this), {
    ...
    value: function compileMutators() {
      this._mutations = mapValues_1(this.mutations(), function (m) {
        return flow_1(m);
      });
    }
    /**
    ...
    key: "getRouteParameters",
    value: function getRouteParameters() {
      return merge_1({}, _get(_getPrototypeOf(Model.prototype), "getRouteParameters", this).call(this), this._attributes);
    }
    /**
    ...
    value: function registerCollection(collection) {
      ...
      if (isNil_1(collection) || isUndefined_1(collection._uid)) {
        throw new Error('Collection is not valid');
      }

      Vue__default["default"].set(this._collections, collection._uid, collection);
    }
    /**
    ...
    value: function unregisterCollection(collection) {
      ...
      Vue__default["default"]["delete"](this._collections, collection._uid);
    }
    /**
    ...
    value: function clearAttributes() {
      ...
      Vue__default["default"].set(this, '_attributes', cloneDeep_1(defaults));
      Vue__default["default"].set(this, '_reference', cloneDeep_1(defaults));
    }
    /**
     * Reverts all attributes back to their defaults, and completely removes all
     * attributes that don't have defaults. This will also sync the reference
    ...
    value: function assign(attributes) {
      this.set(defaults_1({}, attributes, cloneDeep_1(this.defaults())));
      this.sync();
    }
    /**
    ...
    value: function reset(attribute) {
      ...
      if (attribute) {
        copyFrom(this._reference, this._attributes, castArray_1(attribute)); // Reset all attributes if one or more specific ones were not given.
      } else {
    ...
    value: function mutated(attribute, value) {
      var mutator = get_1(this._mutations, attribute);
    ...
    value: function mutate(attribute) {
      ...
      if (isUndefined_1(attribute)) {
        each(this._attributes, function (value, attribute) {
          Vue__default["default"].set(_this3._attributes, attribute, _this3.mutated(attribute, value));
        }); // Only mutate specific attributes.
      } else {
        each(castArray_1(attribute), function (attribute) {
          var current = _this3.get(attribute);

          var mutated = _this3.mutated(attribute, current);

          Vue__default["default"].set(_this3._attributes, attribute, mutated);
        });
      }
    }
    /**
    ...
    value: function sync(attribute) {
      ...
      var active = cloneDeep_1(this._attributes); // Sync either specific attributes or all attributes if none provided.

      if (isUndefined_1(attribute)) {
        Vue__default["default"].set(this, '_reference', active);
      } else {
        each(castArray_1(attribute), function (attribute) {
          Vue__default["default"].set(_this4._reference, attribute, get_1(active, attribute));
        });
      }
    ...
    value: function registerAttribute(attribute) {
      ...
      if (has_1(RESERVED, attribute)) {
        throw new Error("Can't use reserved attribute name '".concat(attribute, "'"));
      ...
      Object.defineProperty(this, attribute, {
        get: function get() {
          return _this5.get(attribute);
        },
        set: function set(value) {
          return _this5.set(attribute, value);
        }
      });
    }
    /**
    ...
    value: function set(attribute, value) {
      ...
      var defined = this.has(attribute); // Only register the pass-through property if it's not already set up.
      ...
      var previous = this.get(attribute); // Run the attribute's mutations if required to do so on change.

      if (this.getOption('mutateOnChange')) {
        value = this.mutated(attribute, value);
      }

      Vue__default["default"].set(this._attributes, attribute, value); // Only consider a change if the attribute was already defined.

      var changed = defined && !isEqual_1(previous, value);
      ...
      if (changed) {
        ...
        if (this.getOption('validateOnChange')) {
          Vue__default["default"].nextTick(function () {
            return _this6.validateAttribute(attribute);
          });
    ...
    key: "unset",
    value: function unset(attribute) {
      var _this7 = this;

      // We're cloning deep to avoid multiple references to the same object,
      // otherwise updating the attributes will also update the reference.
      var defaults = cloneDeep_1(this.defaults()); // Unset either specific attributes or all attributes if none provided.

      var attributes = defaultTo_1(attribute, keys_1(this._attributes)); // Unset either specific attributes or all attributes if none provided.

      each(castArray_1(attributes), function (attribute) {
        if (_this7.has(attribute)) {
          Vue__default["default"].set(_this7._attributes, attribute, get_1(defaults, attribute));
        }
      });
    }
    /**
    ...
    value: function saved(attribute, fallback) {
      return get_1(this._reference, attribute, fallback);
    }
    /**
    ...
    value: function has(attribute) {
      return has_1(this._attributes, attribute);
    }
    /**
     * @return {Array}
     */
    ...
    value: function getValidateRules(attribute) {
      return castArray_1(get_1(this.validation(), attribute, []));
    }
    /**
    ...
    value: function validateAttribute(attribute) {
      ...
      if (!this.has(attribute)) {
        return Promise.reject(new Error("'".concat(attribute, "' is not defined")));
      }

      var value = this.get(attribute);
      var rules = this.getValidateRules(attribute);
      var tasks = rules.map(function (rule) {
        return rule(value, attribute, _this8);
      }); // Check if any nested values should be validated also.

      if (this.getOption('validateRecursively')) {
        if (isFunction_1(get_1(value, 'validate'))) {
          tasks.push(value.validate());
        }
      }

      return Promise.all(tasks).then(function (errors) {
        // Unpack a nested error set.
        if (isArray_1(errors) && isArray_1(first(errors))) {
          errors = first(errors);
        } // Errors will always be messages or nested error objects.


        errors = filter_1(errors, function (e) {
          return isString_1(e) || isObject_1(e);
        }); // Set errors for the model being validated.

        _this8.setAttributeErrors(attribute, errors); // Check to see if we should yield only the first error.


        if (_this8.getOption('useFirstErrorOnly') && !isEmpty_1(errors)) {
          return first(errors);
        }
    ...
    value: function validate(attributes) {
      ...
      if (isUndefined_1(attributes)) {
        attributes = Object.keys(this._attributes);
      } // Support a single, string attribute.


      if (isString_1(attributes)) {
        return this.validateAttribute(attributes).then(function (errors) {
          return !isEmpty_1(errors) ? _defineProperty({}, attributes, errors) : {};
        });
      } // Support an array of attributes to validate.


      if (isArray_1(attributes)) {
        var $errors = {};
        var tasks = attributes.map(function (attribute) {
          return _this9.validateAttribute(attribute).then(function (errors) {
            if (!isEmpty_1(errors)) {
    ...
    value: function addToAllCollections() {
      ...
      each(this._collections, function (collection, id) {
        collection.add(_this10);
      });
    }
    /**
    ...
    value: function changed() {
      ...
      var changed = [];
      each(this._attributes, function (value, attribute) {
        if (!isEqual_1(value, _this12.saved(attribute))) {
          changed.push(attribute);
        }
      });
      return !isEmpty_1(changed) ? changed : false;
    }
    /**
     * Called when a fetch request was successful.
     */
    ...
    key: "onFetchSuccess",
    value: function onFetchSuccess(response) {
      var attributes = response.getData(); // A fetch request must receive *some* data in return.

      if (isEmpty_1(attributes)) {
    ...
    key: "getUpdateMethod",
    value: function getUpdateMethod() {
      return this.shouldPatch() ? this.getPatchMethod() : _get(_getPrototypeOf(Model.prototype), "getUpdateMethod", this).call(this);
    }
    /**
    ...
    value: function getSaveData() {
      ...
      if (this.isExisting() && this.shouldPatch()) {
        return pick_1(this._attributes, this.changed(), this.getOption('identifier'));
      }
    ...
    value: function update(data) {
      ...
      if (!data || isObjectLike_1(data) && isEmpty_1(data)) {
        this.sync(); // A plain object implies that we want to update the model data.
        ...
        this.assign(defaults_1({}, data, this._attributes)); // There is some data, but it's not an object, so we can assume that the
        // response only returned an identifier for this model.
      } else {
        var identifier = this.parseIdentifier(data); // It's possible that the response didn't actually return a valid
        ...
        if (this.isValidIdentifier(identifier)) {
          ...
          var current = this.identifier(); // If an identifier already exists on this model and the returned
    ...
    value: function setAttributeErrors(attribute, errors) {
      if (isEmpty_1(errors)) {
        Vue__default["default"]["delete"](this._errors, attribute);
      } else {
        Vue__default["default"].set(this._errors, attribute, castArray_1(errors));
      }
    }
    /**
    ...
    value: function setErrors(errors) {
      ...
      if (isEmpty_1(errors)) {
        Vue__default["default"].set(this, '_errors', {});
        return;
      }

      each(errors, function (errors, attribute) {
        _this13.setAttributeErrors(attribute, errors);
      });
    }
    /**
    ...
    value: function getErrors() {
      if (this.getOption('useFirstErrorOnly')) {
        return mapValues_1(this._errors, head_1);
      }
    ...
    key: "onSaveSuccess",
    value: function onSaveSuccess(response) {
      var action; // Clear errors because the request was successful.

      this.clearErrors();

      if (response) {
        var responseData = response.getData(); // Find if it's a create or update action

        action = 'update';

        if (response.getStatus() === 201 || !this.saved('id') && isPlainObject_1(responseData) && get_1(responseData, 'id')) {
          action = 'create';
      ...
      Vue__default["default"].set(this, 'saving', false);
      Vue__default["default"].set(this, 'fatal', false); // Automatically add to all registered collections.
    ...
    value: function onFetch() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        Vue__default["default"].set(_this14, 'loading', true);
    ...
    value: function isNew() {
      return isNil_1(this.identifier());
    }
    /**
    ...
    value: function onSave() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        if (!_this15.getOption('saveUnchanged') && !_this15.changed()) {
          resolve(Base.REQUEST_REDUNDANT);
          return;
        }

        Vue__default["default"].set(_this15, 'saving', true); // Mutate attribute before we save if required to do so.

        if (_this15.getOption('mutateBeforeSave')) {
          _this15.mutate();
        }

        _this15.validate().then(function (errors) {
          if (isEmpty_1(errors)) {
            resolve(Base.REQUEST_CONTINUE);
            return;
          }

          Vue__default["default"].set(_this15, 'saving', false);
          reject(_this15.createValidationError(_this15.errors));
          return;
        });
      });
    }
    ...
    value: function onDelete() {
      ...
      return new Promise(function (resolve, reject) {
        Vue__default["default"].set(_this16, 'deleting', true);
        resolve(Base.REQUEST_CONTINUE);
      });
    }
  }]);
...
n(css, {});function normalizeComponent (
  ...
  methods: {
    ...
    fetchItemsMc: function fetchItemsMc() {
      var _this8 = this;
      var page = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
      this.loading = true;
      this.$emit("beforeFetch", {});
      this.collection.page(page).fetch().then(function (response) {
        console.debug("fetch page ", page, response, _this8.collection);
    ...
    fetchItems: function fetchItems() {
      ...
      this.loading = true;
      axios$4.get(this.apiUrl + "/" + this.modelName, {
        params: {
          page: page,
          limit: this.limit,
    ...
    removeItem: function removeItem(id, index) {
      ...
      this.$bvModal.msgBoxConfirm(this.messageRemoveConfirm, {
        ...
        if (value) {
          ...
          axios$4.delete(_this10.apiUrl + "/" + _this10.modelName + "/" + id).then(function (response) {
    ...
    saveSort: function saveSort() {
      ...
      if (this.orderable) {
        ...
        axios$4.post(this.apiUrl + "/" + this.modelName + "/sort", {
          order: order
        }).then(function (response) {
          response.data;
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 11:
              if (_this12.item.id) {
                axios$4.put(_this12.apiUrl + "/" + _this12.modelName + "/" + _this12.item.id, _this12.item).then(function (response) {
                ...
                if (_this12.createMultipart) {
                  ...
                  axios$4.post(_this12.apiUrl + "/" + _this12.modelName, formData).then(function (response) {
                    _this12.loading = false;
                    if (_this12.hideModalAfterSave) {
                      _this12.$bvModal.hide("modal-form-item-" + _this12.modelName);
                    }
                  ...
                  axios$4.post(_this12.apiUrl + "/" + _this12.modelName, _this12.item).then(function (response) {
                    _this12.loading = false;
                    if (_this12.hideModalAfterSave) {
                      _this12.$bvModal.hide("modal-form-item-" + _this12.modelName);
                    }
...
var _sfc_render = function render() {
  ...
  return _c('div', {
  ...
  }, [_vm._t("sidebarFilters", function () {
    return [_c('div', {
    ...
    }, [_c('b-icon-search')], 1)], 1), _vm.displaySearch ? _c('b-form-input', {
      staticClass: "pl-2",
      attrs: {
        "type": "search",
        "required": "",
    ...
    }) : _vm._e()], 1), _vm._t("tableActionsAppend", null, {
      "loading": _vm.loading
    })], 2) : _vm._e()];
  }, {
    "createItem": _vm.createItem,
    ...
    return _vm._l(_vm.columns, function (column, indexc) {
      return _c('th', {
        ...
        "filter": _vm.filter,
        "internalFilterByProp": _vm.internalFilterByProp
      }) : _c('span', [_vm._v(_vm._s(column.label))]), _vm.sortable && _vm.internalFilterByProp(column.prop + '_sort') ? _c('span', {
    ...
    return _c('tr', {
      ...
      return _vm._l(_vm.columns, function (column, indexc) {
        return _c('td', {
        ...
        }, [_vm._t('cell-' + column.prop, function () {
          ...
          }, [_c('b-icon-x-circle')], 1) : _vm._e()], 1) : column.type == 'date' ? _c('span', [_vm._v(" " + _vm._s(_vm.itemValue(column, item) && column.format ? _vm.moment(_vm.itemValue(column, item)).format(column.format) : _vm.itemValue(column, item)) + " ")]) : column.type == 'checkbox' ? _c('span', [_c('b-form-checkbox', {
            on: {
              "change": function change($event) {
          ...
          "itemindex": index,
          "columnindex": indexc
        }), column.type == 'actions' ? _c('b-button-group', [_vm._t("rowAction", function () {
          return [_c('b-button', {
            attrs: {
              "variant": "primary"
            },
...
var __component__ = /*#__PURE__*/normalizeComponent(_sfc_main, _sfc_render, _sfc_staticRenderFns, false, null, "d3acc553", null, null);
