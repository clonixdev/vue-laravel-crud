...
var InfiniteLoading = /*@__PURE__*/getDefaultExportFromCjs(vueInfiniteLoadingExports);var e=[],t=[];function n(n,r){if(n&&"undefined"!=typeof document){var a,s=!0===r.prepend?"prepend":"append",d=!0===r.singleTag,i="string"==typeof r.container?document.querySelector(r.container):document.getElementsByTagName("head")[0];if(d){var u=e.indexOf(i);-1===u&&(u=e.push(i)-1,t[u]={}),a=t[u]&&t[u][s]?t[u][s]:t[u][s]=c();}else a=c();65279===n.charCodeAt(0)&&(n=n.substring(1)),a.styleSheet?a.styleSheet.cssText+=n:a.appendChild(document.createTextNode(n));}function c(){var e=document.createElement("style");if(e.setAttribute("type","text/css"),r.attributes)for(var t=Object.keys(r.attributes),n=0;n<t.length;n++)e.setAttribute(t[n],r.attributes[t[n]]);var a="prepend"===s?"afterbegin":"beforeend";return i.insertAdjacentElement(a,e),e}}var css = "tr td[data-v-34878233]:last-child,\ntr td[data-v-34878233]:first-child {\n  width: 1%;\n  white-space: nowrap; }\n\n.crud-pagination[data-v-34878233] {\n  display: flex;\n  justify-content: center; }\n\n.crud-header[data-v-34878233] {\n  display: flex;\n  justify-content: space-between;\n  max-height: 3rem; }\n  .crud-header[data-v-34878233] .crud-title[data-v-34878233] {\n    margin: 0; }\n  .crud-header[data-v-34878233] .crud-search[data-v-34878233] {\n    max-width: 15rem; }\n    .crud-header[data-v-34878233] .crud-search[data-v-34878233] .btn[data-v-34878233] {\n      border-top-left-radius: 0;\n      border-bottom-left-radius: 0;\n      border-top-right-radius: 0.375rem;\n      border-bottom-right-radius: 0.375rem; }\n      .crud-header[data-v-34878233] .crud-search[data-v-34878233] .btn[data-v-34878233].open[data-v-34878233] {\n        border-top-right-radius: 0;\n        border-bottom-right-radius: 0; }\n  .crud-header[data-v-34878233] .table-options[data-v-34878233] {\n    margin-bottom: 1rem;\n    display: flex;\n    align-items: center;\n    justify-content: flex-end; }\n\n.custom-control[data-v-34878233] {\n  position: relative;\n  top: -15px; }\n\n@media (min-width: 992px) {\n  .table[data-v-34878233] {\n    table-layout: auto; }\n    .table[data-v-34878233] tbody[data-v-34878233] td[data-v-34878233] {\n      overflow: scroll;\n      -ms-overflow-style: none;\n      /* IE and Edge */\n      scrollbar-width: none;\n      /* Firefox */ }\n    .table[data-v-34878233] tbody[data-v-34878233] td[data-v-34878233]::-webkit-scrollbar {\n      display: none; } }\n";
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              validation_error_message = _this16.messageDefaultValidationError;
              if (validation_result) {
                _context4.next = 8;
                break;
              }
              _this16.toastError(validation_error_message);
            ...
            case 11:
              if (!_this16.useVuexORM) {
                _context4.next = 13;
                break;
              }
              return _context4.abrupt("return", _this16.saveItemVuex());
            case 13:
              if (_this16.item.id) {
                axios.put(_this16.apiUrl + "/" + _this16.modelName + "/" + _this16.item.id, _this16.item).then(function (response) {
                  if (_this16.hideModalAfterSave) {
                    _this16.$bvModal.hide("modal-form-item-" + _this16.modelName);
                  }
                  var itemSv = response.data;
                  var itemIndex = _this16.items.findIndex(function (item) {
                    return item.id == _this16.item.id;
                  });
                  _this16.items[itemIndex] = itemSv;
                  _this16.item = itemSv;
                  _this16.loading = false;
                  if (_this16.refreshAfterSave) _this16.refresh();
                  _this16.toastSuccess("Elemento Modificado");
                  _this16.$emit("itemSaved", {
                    item: _this16.item
                  });
                  _this16.$emit("itemUpdated", {
                    item: _this16.item
                  });
                }).catch(function (error) {
                ...
                if (_this16.createMultipart) {
                  formData = new FormData();
                  Object.keys(_this16.item).forEach(function (key) {
                    if (_this16.item[key][0] && _this16.item[key][0].name) {
                      var files = _this16.item[key];
                      for (var x = 0; x < files.length; x++) {
                        formData.append(key + "[]", _this16.item[key][x], _this16.item[key][x].name);
                      }
                    } else formData.append(key, _this16.item[key]);
                  });
                  axios.post(_this16.apiUrl + "/" + _this16.modelName, formData).then(function (response) {
                    _this16.loading = false;
                    if (_this16.hideModalAfterSave) {
                      _this16.$bvModal.hide("modal-form-item-" + _this16.modelName);
                    }
                    if (response.data.success) {
                      if (response.data.message) {
                        _this16.toastSuccess(response.data.message);
                      }
                      return;
                    }
                    var itemSv = response.data;
                    _this16.items.push(itemSv);
                    _this16.item = itemSv;
                    if (_this16.refreshAfterSave) _this16.refresh();
                    _this16.toastSuccess("Elemento Creado");
                    _this16.$emit("itemSaved", {
                      item: _this16.item
                    });
                    _this16.$emit("itemCreated", {
                      item: _this16.item
                    });
                  }).catch(function (error) {
                    _this16.toastError(error);
                  ...
                  axios.post(_this16.apiUrl + "/" + _this16.modelName, _this16.item).then(function (response) {
                    _this16.loading = false;
                    if (_this16.hideModalAfterSave) {
                      _this16.$bvModal.hide("modal-form-item-" + _this16.modelName);
                    }
...
var __component__ = /*#__PURE__*/normalizeComponent(_sfc_main, _sfc_render, _sfc_staticRenderFns, false, null, "34878233", null, null);
