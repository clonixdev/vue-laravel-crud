...
var InfiniteLoading = /*@__PURE__*/getDefaultExportFromCjs(vueInfiniteLoadingExports);var e=[],t=[];function n(n,r){if(n&&"undefined"!=typeof document){var a,s=!0===r.prepend?"prepend":"append",d=!0===r.singleTag,i="string"==typeof r.container?document.querySelector(r.container):document.getElementsByTagName("head")[0];if(d){var u=e.indexOf(i);-1===u&&(u=e.push(i)-1,t[u]={}),a=t[u]&&t[u][s]?t[u][s]:t[u][s]=c();}else a=c();65279===n.charCodeAt(0)&&(n=n.substring(1)),a.styleSheet?a.styleSheet.cssText+=n:a.appendChild(document.createTextNode(n));}function c(){var e=document.createElement("style");if(e.setAttribute("type","text/css"),r.attributes)for(var t=Object.keys(r.attributes),n=0;n<t.length;n++)e.setAttribute(t[n],r.attributes[t[n]]);var a="prepend"===s?"afterbegin":"beforeend";return i.insertAdjacentElement(a,e),e}}var css = "tr td[data-v-915832a6]:last-child,\ntr td[data-v-915832a6]:first-child {\n  width: 1%;\n  white-space: nowrap; }\n\n.crud-pagination[data-v-915832a6] {\n  display: flex;\n  justify-content: center; }\n\n.crud-header[data-v-915832a6] {\n  display: flex;\n  justify-content: space-between;\n  max-height: 3rem; }\n  .crud-header[data-v-915832a6] .crud-title[data-v-915832a6] {\n    margin: 0; }\n  .crud-header[data-v-915832a6] .crud-search[data-v-915832a6] {\n    max-width: 15rem; }\n    .crud-header[data-v-915832a6] .crud-search[data-v-915832a6] .btn[data-v-915832a6] {\n      border-top-left-radius: 0;\n      border-bottom-left-radius: 0;\n      border-top-right-radius: 0.375rem;\n      border-bottom-right-radius: 0.375rem; }\n      .crud-header[data-v-915832a6] .crud-search[data-v-915832a6] .btn[data-v-915832a6].open[data-v-915832a6] {\n        border-top-right-radius: 0;\n        border-bottom-right-radius: 0; }\n  .crud-header[data-v-915832a6] .table-options[data-v-915832a6] {\n    margin-bottom: 1rem;\n    display: flex;\n    align-items: center;\n    justify-content: flex-end; }\n\n.custom-control[data-v-915832a6] {\n  position: relative;\n  top: -15px; }\n\n@media (min-width: 992px) {\n  .table[data-v-915832a6] {\n    table-layout: auto; }\n    .table[data-v-915832a6] tbody[data-v-915832a6] td[data-v-915832a6] {\n      overflow: scroll;\n      -ms-overflow-style: none;\n      /* IE and Edge */\n      scrollbar-width: none;\n      /* Firefox */ }\n    .table[data-v-915832a6] tbody[data-v-915832a6] td[data-v-915832a6]::-webkit-scrollbar {\n      display: none; } }\n";
n(css, {});function normalizeComponent (
  ...
  methods: {
    infiniteHandler: function infiniteHandler($state) {
      var hasNextPage = this.pagination.current_page * this.pagination.per_page < this.pagination.total;
      if (hasNextPage) {
    ...
    fetchItems: function fetchItems() {
      ...
      return axios.get(this.apiUrl + "/" + this.modelName, {
        ...
        if (_this9.grouped) {
          ...
          if (concat) {
            _this9.items = _this9.items.concat(itemswithgroup);
          } else {
            _this9.items = itemswithgroup;
          }
        } else {
          if (concat) {
            _this9.items = _this9.items.concat(items);
          } else {
            _this9.items = items;
          }
        }
...
var _sfc_render = function render() {
  ...
  return _c('div', {
    ...
    staticClass: "text-center"
  }, [_vm._v(_vm._s(_vm.pagination.current_page == 1 ? _vm.messageEmptyResults : _vm.messageNoMore))]) : _vm._e()])]) : _vm._e()], 2)], 1), !_vm.loading && _vm.items.length == 0 && !_vm.infiniteScroll ? _c('p', {
    staticClass: "p-3"
    ...
    staticClass: "text-center"
  }, [_vm._v(_vm._s(_vm.pagination.current_page == 1 ? _vm.messageEmptyResults : _vm.messageNoMore))]) : _vm._e()])]) : _vm._e()], 2)], 1) : _vm._e(), _vm.displayMode == _vm.displayModes.MODE_CUSTOM ? _c('div', [_c('div', {
...
var __component__ = /*#__PURE__*/normalizeComponent(_sfc_main, _sfc_render, _sfc_staticRenderFns, false, null, "915832a6", null, null);
