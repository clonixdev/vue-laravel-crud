...
Sortable.mount(Remove, Revert);var sortable_esm=/*#__PURE__*/Object.freeze({__proto__:null,'default': Sortable,MultiDrag: MultiDragPlugin,Sortable: Sortable,Swap: SwapPlugin});var require$$0 = /*@__PURE__*/getAugmentedNamespace(sortable_esm);var vuedraggable_umd = createCommonjsModule$1(function (module, exports) {
...
var draggable = /*@__PURE__*/getDefaultExportFromCjs(vuedraggable_umd);var bind$1 = function bind(fn, thisArg) {
...
var InterceptorManager_1$1 = InterceptorManager$1;var normalizeHeaderName$1 = function normalizeHeaderName(headers, normalizedName) {
...
var browser$3 = createCommonjsModule$1(function (module, exports) {
/**
...
var debug_1 = function () {
  if (!debug$2) {
    try {
      ...
      debug$2 = src$1("follow-redirects");
    }
    catch (error) { /* */ }
...
var Writable$1 = require$$0__default['default'].Writable;
...
RedirectableRequest$1.prototype = Object.create(Writable$1.prototype);
...
RedirectableRequest$1.prototype.write = function (data, encoding, callback) {
  ...
  if (!isString$2(data) && !isBuffer$1(data)) {
...
RedirectableRequest$1.prototype._performRequest = function () {
  ...
  for (var event of events) {
    request.on(event, eventHandlers$1[event]);
  }
...
function abortRequest(request) {
  for (var event of events) {
    request.removeListener(event, eventHandlers$1[event]);
  }
...
function isSubdomain(subdomain, domain) {
  assert__default['default'](isString$2(subdomain) && isString$2(domain));
...
// Exports
var followRedirects$1 = wrap$1({ http: http__default['default'], https: https__default['default'] });
var wrap_1$1 = wrap$1;
followRedirects$1.wrap = wrap_1$1;var _from$1 = "axios@^0.21.1";
...
var _where$1 = "F:\\laragon\\www\\vue-laravel-crud";
var author$1 = {
	name: "Matt Zabriskie"
};
var browser$2 = {
...
var pkg$1 = {
	...
	unpkg: unpkg,
	version: version$1
};var httpFollow$1 = followRedirects$1.http;
var httpsFollow$1 = followRedirects$1.https;
      ...
      if (config.responseType === 'stream') {
        ...
        stream.on('data', function handleStreamData(chunk) {
          ...
          if (config.maxContentLength > -1 && totalResponseBytes > config.maxContentLength) {
            stream.destroy();
            reject(createError$1('maxContentLength size of ' + config.maxContentLength + ' exceeded',
...
utils$1.forEach(['post', 'put', 'patch'], function forEachMethodWithData(method) {
  defaults$2.headers[method] = utils$1.merge(DEFAULT_CONTENT_TYPE$1);
});

var defaults_1$2 = defaults$2;/**
...
var dispatchRequest$1 = function dispatchRequest(config) {
  ...
  var adapter = config.adapter || defaults_1$2.adapter;
...
var axios$3 = createInstance$1(defaults_1$2);
...
axios$3.create = function create(instanceConfig) {
  return createInstance$1(mergeConfig$1(axios$3.defaults, instanceConfig));
};
...
axios_1$1.default = _default$1;var axios$2 = axios_1$1;var moment = createCommonjsModule$1(function (module, exports) {
...
var wrap_1 = wrap;
followRedirects.wrap = wrap_1;var _from = "axios@0.19.0";
...
var _where = "F:\\laragon\\www\\vue-laravel-crud\\node_modules\\vue-mc";
var author = {
	name: "Matt Zabriskie"
};
var browser = {
...
axios_1.default = _default;var axios = axios_1;function _classCallCheck(instance, Constructor) {
...
function (_Base) {
  ...
  methods: {
    ...
    fetchItems: function fetchItems() {
      ...
      this.loading = true;
      axios$2.get(this.apiUrl + "/" + this.modelName, {
        params: {
          page: page,
          limit: this.limit,
    ...
    removeItem: function removeItem(id, index) {
      ...
      this.$bvModal.msgBoxConfirm(this.messageRemoveConfirm, {
        ...
        if (value) {
          ...
          axios$2.delete(_this10.apiUrl + "/" + _this10.modelName + "/" + id).then(function (response) {
    ...
    saveSort: function saveSort() {
      ...
      if (this.orderable) {
        ...
        axios$2.post(this.apiUrl + "/" + this.modelName + "/sort", {
          order: order
        }).then(function (response) {
          response.data;
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 11:
                if (_this12.item.id) {
                  axios$2.put(_this12.apiUrl + "/" + _this12.modelName + "/" + _this12.item.id, _this12.item).then(function (response) {
                  ...
                  if (_this12.createMultipart) {
                    ...
                    axios$2.post(_this12.apiUrl + "/" + _this12.modelName, formData).then(function (response) {
                      _this12.loading = false;
                    ...
                    axios$2.post(_this12.apiUrl + "/" + _this12.modelName, _this12.item).then(function (response) {
                      _this12.loading = false;
...
var __vue_render__ = function __vue_render__() {
  ...
  return _c('div', {
    staticClass: "crud"
  }, [_vm.showHeader ? _vm._ssrNode("<div class=\"crud-header\" data-v-2d88ff5d>", "</div>", [_vm._ssrNode((_vm.showTitle ? "<h4 class=\"crud-title\" data-v-2d88ff5d>" + _vm._ssrEscape(_vm._s(_vm.title)) + "</h4>" : "<!---->") + " "), _c('b-sidebar', {
    attrs: {
      "title": "Filtrar",
      "right": "",
      "shadow": ""
    ...
    return _c('div', {
      ...
      staticClass: "form-group"
    }, [_c('label', [_vm._v(_vm._s(column.label))]), _vm._v(" "), _c('div', {
      staticClass: "d-none"
    }, [_vm._v(_vm._s(column.options))]), _vm._v(" "), _c('select', {
      directives: [{
        name: "model",
        rawName: "v-model",
        value: _vm.internalFilterByProp(column.prop).value,
  ...
  })], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"table-options\" data-v-2d88ff5d>", "</div>", [_c('b-button-group', {
    staticClass: "mr-1"
  ...
  }), 0)], 1), _vm._v(" "), _vm.items.length == 0 ? _c('p', {
    staticClass: "p-3"
  ...
  }), 1)], 1) : _vm._e(), _vm._v(" "), _vm.displayMode == _vm.displayModes.MODE_CUSTOM ? _c('div', [_c('div', {
  ...
  })], 2)]) : _vm._e()]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"crud-paginator\" data-v-2d88ff5d>", "</div>", [_vm.showPaginator ? _c('b-pagination', {
    attrs: {
  ...
  }) : _vm._e(), _vm._v(_vm._s(_vm.messageSave) + "\n          ")], 1)] : _vm._e()], 2)], 1), _vm._ssrNode(" "), _c('b-modal', {
    attrs: {
...
var __vue_inject_styles__ = function __vue_inject_styles__(inject) {
  if (!inject) return;
  inject("data-v-2d88ff5d_0", {
    source: "tr td[data-v-2d88ff5d]:first-child,tr td[data-v-2d88ff5d]:last-child{width:1%;white-space:nowrap}.crud-pagination[data-v-2d88ff5d]{display:flex;justify-content:center}.crud-header[data-v-2d88ff5d]{display:flex;justify-content:space-between;max-height:3rem}.crud-header .crud-title[data-v-2d88ff5d]{margin:0}.crud-header .crud-search[data-v-2d88ff5d]{max-width:15rem}.crud-header .crud-search .btn[data-v-2d88ff5d]{border-top-left-radius:0;border-bottom-left-radius:0;border-top-right-radius:.375rem;border-bottom-right-radius:.375rem}.crud-header .crud-search .btn.open[data-v-2d88ff5d]{border-top-right-radius:0;border-bottom-right-radius:0}.crud-header .table-options[data-v-2d88ff5d]{margin-bottom:1rem;display:flex;align-items:center;justify-content:flex-end}.custom-control[data-v-2d88ff5d]{position:relative;top:-15px}@media (min-width:992px){.table[data-v-2d88ff5d]{table-layout:auto}.table tbody td[data-v-2d88ff5d]{overflow:scroll;-ms-overflow-style:none;scrollbar-width:none}.table tbody td[data-v-2d88ff5d]::-webkit-scrollbar{display:none}}",
    map: undefined,
    media: undefined
  });
};
...
var __vue_scope_id__ = "data-v-2d88ff5d";
/* module identifier */

var __vue_module_identifier__ = "data-v-2d88ff5d";
/* functional template */
