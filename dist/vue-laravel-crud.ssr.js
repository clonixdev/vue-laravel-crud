...
var _sfc_render$c = function render() {
  ...
  }, [_vm._t('cell-' + _vm.column.prop, function () {
    return [_vm.column.type == 'boolean' ? _c('span', [_vm.itemValue(_vm.column, _vm.item) == 'true' || _vm.itemValue(_vm.column, _vm.item) == 1 || _vm.itemValue(_vm.column, _vm.item) == '1' ? _c('b-badge', {
      attrs: {
        "variant": "success"
      }
    }, [_c('b-icon-check-circle')], 1) : _vm._e(), !_vm.itemValue(_vm.column, _vm.item) || _vm.itemValue(_vm.column, _vm.item) == '0' || _vm.itemValue(_vm.column, _vm.item) == 'false' ? _c('b-badge', {
      attrs: {
        "variant": "danger"
      }
    }, [_c('b-icon-x-circle')], 1) : _vm._e()], 1) : _vm.column.type == 'date' ? _c('span', [_vm._v(" " + _vm._s(_vm.itemValue(_vm.column, _vm.item) ? _vm.moment(_vm.itemValue(_vm.column, _vm.item)).format(_vm.column.format ? _vm.column.format : 'L LT') : _vm.itemValue(_vm.column, _vm.item)) + " ")]) : _vm.column.type == 'select' ? _c('span', [_c('b-form-checkbox', {
      on: {
        "change": function change($event) {
...
var TableCell = __component__$c.exports;var _sfc_main$b = {
  ...
  inject: ['columns', 'onRowHover', 'onRowClick']
};
var _sfc_render$b = function render() {
  ...
  return _c('tr', {
    ...
    on: {
      ...
      "click": function click($event) {
        return _vm.onRowClick(_vm.item, _vm.index);
      }
    }
  }, [_vm.grouped && _vm.item.crudgroup ? _c('th', {
    attrs: {
      "colspan": _vm.columns.length
    }
  }, [_c('span', [_vm._v(_vm._s(_vm.item.crudgrouplabel))])]) : _vm._t("row", function () {
    return _vm._l(_vm.columns, function (column, indexc) {
      return _c('TableCell', {
        key: indexc,
        attrs: {
...
var __component__$b = /*#__PURE__*/normalizeComponent(_sfc_main$b, _sfc_render$b, _sfc_staticRenderFns$b, false, null, null, null, null);
var TableRow = __component__$b.exports;var _sfc_main$a = {
  name: 'CrudTable',
  components: {
    draggable: draggable,
...
var CrudTable = __component__$a.exports;/*!
...
var _sfc_render$7 = function render() {
  ...
  return _c('div', {
    ...
    class: _vm.cardClass,
    attrs: {
      "title": _vm.item.title || _vm.item.name || "Item ".concat(_vm.item.id),
      "tag": "article",
      "hide-footer": _vm.cardHideFooter
    },
    scopedSlots: _vm._u([{
    ...
    return _vm._l(_vm.columns, function (column, indexc) {
      return _c('div', {
        key: indexc
      }, [column.type !== 'actions' && column.prop !== 'id' ? _c('b-card-text', [_c('small', {
...
var _sfc_render$6 = function render() {
  ...
  }, [_c('span', [_vm._v(_vm._s(_vm.column.groupLabel))]), _c('b-badge', {
    attrs: {
      "variant": "secondary"
    }
  }, [_vm._v(_vm._s(_vm.column.items.length))])], 1)]), _c('draggable', {
    staticClass: "kanban-column-body",
    attrs: {
      "group": "kanban",
      "data-column": _vm.column.groupKey
    },
    on: {
      "end": _vm.onDragEnd
    },
    model: {
      value: _vm.column.items,
      callback: function callback($$v) {
        _vm.$set(_vm.column, "items", $$v);
      },
      expression: "column.items"
    }
  }, _vm._l(_vm.column.items, function (item, itemIndex) {
    return _c('div', {
      key: itemIndex,
      staticClass: "item"
    }, [_vm._t("card", function () {
...
var _sfc_render$5 = function render() {
  ...
  }, _vm._l(_vm.items, function (column, colIndex) {
    return _c('div', {
      key: colIndex,
      staticClass: "kanban-column"
    }, [_c('KanbanColumn', {
      attrs: {
        "column": column,
        "colIndex": colIndex,
        "groupedAttribute": _vm.groupedAttribute,
        "columns": _vm.columns,
        "itemValue": _vm.itemValue,
        "getStateValue": _vm.getStateValue,
        "getStateOptions": _vm.getStateOptions,
...
n(css$2, {});var _sfc_main$2 = {
  ...
  computed: {
    modalUidSuffix: function modalUidSuffix() {
      return this.instanceUid ? "-" + this.instanceUid : "";
    },
    modalFormId: function modalFormId() {
      return "modal-form-item-" + this.modelName + this.modalUidSuffix;
    },
    modalShowId: function modalShowId() {
...
var _sfc_render$1 = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_vm.infiniteScroll ? _c('infinite-loading', {
...
})();var utils=/*#__PURE__*/Object.freeze({__proto__:null,hasBrowserEnv:hasBrowserEnv,hasStandardBrowserWebWorkerEnv:hasStandardBrowserWebWorkerEnv,hasStandardBrowserEnv:hasStandardBrowserEnv});var platform = {
  ...utils,
  ...platform$1
...
function mergeConfig(config1, config2) {
  ...
  return config;
}const VERSION = "1.6.7";const validators$1 = {};
...
axios.default = axios;var crudApi = {
  methods: {
    getFormModalId: function getFormModalId() {
      var modalUidSuffix = this.instanceUid ? "-" + this.instanceUid : "";
          ...
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 39:
              ...
              if (_this5.hideModalAfterSave || create && _this5.hideModalAfterCreate || !create && _this5.hideModalAfterUpdate) {
                _this5.$bvModal.hide(_this5.getFormModalId());
              }
            case 43:
            case "end":
            ...
            case 0:
              ...
              if (_this6.item.id || _this6.item.index) {
                ...
                if (_this6.hideModalAfterSave || _this6.hideModalAfterUpdate) {
                  _this6.$bvModal.hide(_this6.getFormModalId());
                }
              } else {
              ...
              if (_this7.item.id) {
                axios.put(_this7.buildApiEndpoint(_this7.modelName, _this7.item.id), _this7.item).then(function (response) {
                  if (_this7.hideModalAfterSave || _this7.hideModalAfterUpdate) {
                    _this7.$bvModal.hide(_this7.getFormModalId());
                  }
  ...
  methods: {
    getModalId: function getModalId(type) {
      var modalUidSuffix = this.instanceUid ? "-" + this.instanceUid : "";
    ...
    showItem: function showItem(id) {
      ...
      this.$nextTick(function () {
        _this5.$forceUpdate();
        _this5.$bvModal.show(_this5.getModalId("show"));
      });
    },
    createItem: function createItem() {
      ...
      this.$nextTick(function () {
        _this6.$forceUpdate();
        _this6.$bvModal.show(_this6.getModalId("form"));
      });
    },
    updateItem: function updateItem(id) {
      ...
      this.$nextTick(function () {
        _this7.$forceUpdate();
        _this7.$bvModal.show(_this7.getModalId("form"));
      });
    },
