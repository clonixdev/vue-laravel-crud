...
var draggable = /*@__PURE__*/getDefaultExportFromCjs(vuedraggable_umdExports);var global$1 = (typeof global !== "undefined" ? global :
  ...
  typeof window !== "undefined" ? window : {});function bind(fn, thisArg) {
...
var InfiniteLoading = /*@__PURE__*/getDefaultExportFromCjs(vueInfiniteLoadingExports);var e=[],t=[];function n(n,r){if(n&&"undefined"!=typeof document){var a,s=!0===r.prepend?"prepend":"append",d=!0===r.singleTag,i="string"==typeof r.container?document.querySelector(r.container):document.getElementsByTagName("head")[0];if(d){var u=e.indexOf(i);-1===u&&(u=e.push(i)-1,t[u]={}),a=t[u]&&t[u][s]?t[u][s]:t[u][s]=c();}else a=c();65279===n.charCodeAt(0)&&(n=n.substring(1)),a.styleSheet?a.styleSheet.cssText+=n:a.appendChild(document.createTextNode(n));}function c(){var e=document.createElement("style");if(e.setAttribute("type","text/css"),r.attributes)for(var t=Object.keys(r.attributes),n=0;n<t.length;n++)e.setAttribute(t[n],r.attributes[t[n]]);var a="prepend"===s?"afterbegin":"beforeend";return i.insertAdjacentElement(a,e),e}}var css = "tr td[data-v-3ea4ea43]:last-child,\ntr td[data-v-3ea4ea43]:first-child {\n  width: 1%;\n  white-space: nowrap; }\n\n.crud-pagination[data-v-3ea4ea43] {\n  display: flex;\n  justify-content: center; }\n\n.crud-header[data-v-3ea4ea43] {\n  display: flex;\n  justify-content: space-between;\n  max-height: 3rem; }\n  .crud-header[data-v-3ea4ea43] .crud-title[data-v-3ea4ea43] {\n    margin: 0; }\n  .crud-header[data-v-3ea4ea43] .crud-search[data-v-3ea4ea43] {\n    max-width: 15rem; }\n    .crud-header[data-v-3ea4ea43] .crud-search[data-v-3ea4ea43] .btn[data-v-3ea4ea43] {\n      border-top-left-radius: 0;\n      border-bottom-left-radius: 0;\n      border-top-right-radius: 0.375rem;\n      border-bottom-right-radius: 0.375rem; }\n      .crud-header[data-v-3ea4ea43] .crud-search[data-v-3ea4ea43] .btn[data-v-3ea4ea43].open[data-v-3ea4ea43] {\n        border-top-right-radius: 0;\n        border-bottom-right-radius: 0; }\n  .crud-header[data-v-3ea4ea43] .table-options[data-v-3ea4ea43] {\n    margin-bottom: 1rem;\n    display: flex;\n    align-items: center;\n    justify-content: flex-end; }\n\n.custom-control[data-v-3ea4ea43] {\n  position: relative;\n  top: -15px; }\n\n@media (min-width: 992px) {\n  .table[data-v-3ea4ea43] {\n    table-layout: auto; }\n    .table[data-v-3ea4ea43] tbody[data-v-3ea4ea43] td[data-v-3ea4ea43] {\n      overflow: scroll;\n      -ms-overflow-style: none;\n      /* IE and Edge */\n      scrollbar-width: none;\n      /* Firefox */ }\n    .table[data-v-3ea4ea43] tbody[data-v-3ea4ea43] td[data-v-3ea4ea43]::-webkit-scrollbar {\n      display: none; } }\n";
n(css, {});function normalizeComponent (
  ...
  methods: {
    infiniteHandler: function infiniteHandler($state) {
      var hasNextPage = this.pagination.total > 0 && (!this.firstLoad || this.pagination.current_page * this.pagination.per_page <= this.pagination.total);
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return _this13.model.api().delete('/' + id, {
                delete: 1
              });
            case 2:
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              console.debug("save item 1", _this15.item);
              jsondata = _this15.item.$toJson();
              console.debug("save item 2", _this15.item, jsondata);
              create = false;
              if (!_this15.item.id) {
                _context3.next = 12;
                break;
              ...
              _context3.next = 8;
              return _this15.model.api().put('/' + _this15.item.id, jsondata);
            case 8:
            ...
            case 12:
              _context3.next = 14;
              return _this15.model.api().post('', jsondata);
            case 14:
              result = _context3.sent;
              create = true;
            case 16:
            ...
            case 21:
              ...
              if (_this15.hideModalAfterSave || create && _this15.hideModalAfterCreate || !create && _this15.hideModalAfterUpdate) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              itemSave = JSON.parse(JSON.stringify(_this16.item));
              if (_this16.item.id) {
                itemIndex = _this16.items.findIndex(function (item) {
                  return item.id == _this16.item.id;
                });
                _this16.items[itemIndex] = itemSave;
                if (_this16.hideModalAfterSave || _this16.hideModalAfterUpdate) {
                  _this16.$bvModal.hide("modal-form-item-" + _this16.modelName);
                }
              } else {
                _this16.items.push(itemSave);
                if (_this16.hideModalAfterSave || _this16.hideModalAfterCreate) {
                  _this16.$bvModal.hide("modal-form-item-" + _this16.modelName);
                }
              }
              _this16.toastSuccess("Elemento Modificado");
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              ...
              validation_error_message = _this17.messageDefaultValidationError;
              if (validation_result) {
                _context5.next = 8;
                break;
              }
              _this17.toastError(validation_error_message);
            ...
            case 11:
              if (!_this17.useVuexORM) {
                _context5.next = 13;
                break;
              }
              return _context5.abrupt("return", _this17.saveItemVuex(event));
            case 13:
              if (_this17.ajax) {
                _context5.next = 15;
                break;
              }
              return _context5.abrupt("return", _this17.saveItemLocal(event));
            case 15:
              if (_this17.item.id) {
                axios.put(_this17.apiUrl + "/" + _this17.modelName + "/" + _this17.item.id, _this17.item).then(function (response) {
                  if (_this17.hideModalAfterSave || _this17.hideModalAfterUpdate) {
                    _this17.$bvModal.hide("modal-form-item-" + _this17.modelName);
                  }
                  var itemSv = response.data;
                  var itemIndex = _this17.items.findIndex(function (item) {
                    return item.id == _this17.item.id;
                  });
                  _this17.items[itemIndex] = itemSv;
                  _this17.item = itemSv;
                  _this17.loading = false;
                  if (_this17.refreshAfterSave) _this17.refresh();
                  _this17.toastSuccess("Elemento Modificado");
                  _this17.$emit("itemSaved", {
                    item: _this17.item
                  });
                  _this17.$emit("itemUpdated", {
                    item: _this17.item
                  });
                }).catch(function (error) {
                ...
                if (_this17.createMultipart) {
                  formData = new FormData();
                  Object.keys(_this17.item).forEach(function (key) {
                    if (_this17.item[key][0] && _this17.item[key][0].name) {
                      var files = _this17.item[key];
                      for (var x = 0; x < files.length; x++) {
                        formData.append(key + "[]", _this17.item[key][x], _this17.item[key][x].name);
                      }
                    } else formData.append(key, _this17.item[key]);
                  });
                  axios.post(_this17.apiUrl + "/" + _this17.modelName, formData).then(function (response) {
                    _this17.loading = false;
                    if (_this17.hideModalAfterSave || _this17.hideModalAfterCreate) {
                      _this17.$bvModal.hide("modal-form-item-" + _this17.modelName);
                    }
                    if (response.data.success) {
                      if (response.data.message) {
                        _this17.toastSuccess(response.data.message);
                      }
                      return;
                    }
                    var itemSv = response.data;
                    _this17.items.push(itemSv);
                    _this17.item = itemSv;
                    if (_this17.refreshAfterSave) _this17.refresh();
                    _this17.toastSuccess("Elemento Creado");
                    _this17.$emit("itemSaved", {
                      item: _this17.item
                    });
                    _this17.$emit("itemCreated", {
                      item: _this17.item
                    });
                  }).catch(function (error) {
                    _this17.toastError(error);
                  ...
                  axios.post(_this17.apiUrl + "/" + _this17.modelName, _this17.item).then(function (response) {
                    _this17.loading = false;
                    if (_this17.hideModalAfterSave || _this17.hideModalAfterUpdate) {
                      _this17.$bvModal.hide("modal-form-item-" + _this17.modelName);
                    }
...
var _sfc_render = function render() {
  ...
  return _c('div', {
    ...
    }, [_vm.grouped && item.crudgroup ? _c('th', {
      attrs: {
...
var __component__ = /*#__PURE__*/normalizeComponent(_sfc_main, _sfc_render, _sfc_staticRenderFns, false, null, "3ea4ea43", null, null);
