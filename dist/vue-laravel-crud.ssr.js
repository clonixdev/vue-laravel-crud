'use strict';var process=require('process'),Vue=require('vue');function _interopDefaultLegacy(e){return e&&typeof e==='object'&&'default'in e?e:{'default':e}}var process__default=/*#__PURE__*/_interopDefaultLegacy(process);var Vue__default=/*#__PURE__*/_interopDefaultLegacy(Vue);function _typeof$1(obj) {
...
var PluginManager = {
  mount: function mount(plugin) {
    ...
    for (var option in defaults$7) {
      if (defaults$7.hasOwnProperty(option) && !(option in plugin)) {
        plugin[option] = defaults$7[option];
      }
    }
...
var InterceptorManager_1$1 = InterceptorManager$1;var utils$2 = require('./utils');
var normalizeHeaderName$1 = require('./helpers/normalizeHeaderName');
...
function getDefaultAdapter$1() {
  ...
  } else if (typeof process__default['default'] !== 'undefined' && Object.prototype.toString.call(process__default['default']) === '[object process]') {
...
utils$2.forEach(['post', 'put', 'patch'], function forEachMethodWithData(method) {
  defaults$5.headers[method] = utils$2.merge(DEFAULT_CONTENT_TYPE$1);
});

module.exports = defaults$5;var defaults$6=/*#__PURE__*/Object.freeze({__proto__:null});var defaults$4 = /*@__PURE__*/getAugmentedNamespace(defaults$6);/**
...
function createInstance$1(defaultConfig) {
  ...
  utils$3.extend(instance, Axios_1$1.prototype, context);
...
(function (global, factory) {
  ...
  typeof window !== "undefined" ? window : {});var bind = function bind(fn, thisArg) {
  return function wrap() {
    var args = new Array(arguments.length);
    for (var i = 0; i < args.length; i++) {
      args[i] = arguments[i];
...
function getDefaultAdapter() {
  ...
  if (typeof process__default['default'] !== 'undefined' && Object.prototype.toString.call(process__default['default']) === '[object process]') {
    // For node use HTTP adapter
    adapter = require('./adapters/http');
...
module.exports = defaults$2;var defaults$3=/*#__PURE__*/Object.freeze({__proto__:null});/**
...
var combineURLs = function combineURLs(baseURL, relativeURL) {
  return relativeURL
    ...
    : baseURL;
};var defaults$1 = /*@__PURE__*/getAugmentedNamespace(defaults$3);/**
 * Throws a `Cancel` if cancellation has been requested.
 */
